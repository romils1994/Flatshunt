                ...
                <div class="col s12 m6">
                    <div class="card hoverable wow fadeInRight" id="cols" data-wow-duration="2s">
                        <div class="card-content blue-grey-text">
                            ...
                            <div class="row">
                                <iframe width="100%" height="330" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJByw5MBHJ5zsRMemNHDm_Rzw&key=AIzaSyAB9itOCse1a9IYHHNbYd0MDPw_ZzZTc90" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
