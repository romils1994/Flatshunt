        ...
        <ul style="left:-300%; bottom:0px">
            <div class="card m12">
                ...
                <form class="contact_form" id="contact_form" name="contact_form" novalidate="novalidate">
                    <input type="hidden" name="rent_id" value="<?php echo $_GET['id']?>">
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            <input id="contact_phone" name="contact_phone" type="tel" maxlength="10" length="10" class="validate validate[required] initialized" data-error=".errorTxt8" required="required" aria-required="true">
                        ...
                        $("#contact_form").validate({
                            ...
                            messages:{
                                ...
                                contact_msg:{
                                    ...
                                    maxlength:"Please Dont write an essay"
                                }                                            
                            },
                            errorElement : 'div',
            ...
            echo "<div class='container'>
                    ...
                    <div class='card hoverable'>
                        <div class='card-content'>
                            ...
                            <div class='row'>
                                ...
                                <div class='col s3 m3'>"
                                    .$row['Construction_Age'].
                                "</div>
                                <div class='col s9 m3'>
                                    <label>Preferred Tenants:</label>
                                </div>
                                <div class='col s3 m3'>"
                                    .$row['Preferred_tenant'].
                                "</div>
                            </div>
                        </div>
                    </div>
                    <div class='card hoverable'>
                        <div class='card-content'>
                            ...
                            <div class='col s12 m12' id='rent_map' style='height:380px;'></div>
                        </div>
                    </div>
                </div>
